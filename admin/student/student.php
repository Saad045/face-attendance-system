                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="my-4 float-right mr-4">
                                ...
                                <a href="../student_timetable/student_timetable.php"
                                    class=" btn btn-dark btn-sm text-white ">
                                    <i class="fas fa-calendar-alt text-white  mr-1"></i>
                                    TIME-TABLE
                                </a>
                                <a href="../attendance_sheet/attendance_sheet.php"
                                    class=" btn btn-dark btn-sm text-white    ">
                                    ...
                                    <table class="table table-borderless ">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <tr class="row-color">
                                                    <td class="round-left">
                                                        <span class="badge badge-primary sticky-top">
                                                            <?php echo $row['id']; ?>
                                                        </span>
                                                        <div><img src="../<?php echo $row['picture']; ?>" alt="img..."
                                                                class="profile_pic mt-n4"></div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="badge badge-primary" data-toggle="tooltip" data-html="true"
                                                            title="Department">
                                                            <?php echo $row['department']; ?>
                                                        </span>
                                                        <span class="badge badge-success" data-toggle="tooltip" data-html="true"
                                                            title="Degree Enrolled">
                                                            <?php echo $row['degree']; ?>
                                                        </span>
                                                        ...
                                                        <span class="badge badge-dark" data-toggle="tooltip" data-html="true"
                                                            title="Semester">
                                                    ...
                                                    <td>
                                                        <a href="mailto:<?php echo $row['email']; ?>" data-toggle="tooltip"
                                                            data-html="true" title="Send mail to <?php echo $row['email']; ?>">
                                                            <span class="d-inline-block text-truncate"
                                                                style="max-width: 150px;">
                                                                <?php echo $row['email']; ?>
                                                            </span></a><br>

                                                        <a href="tel:<?php echo $row['phone']; ?>" data-toggle="tooltip"
                                                            data-html="true"
                                                            title="Make Call <?php echo $row['phone']; ?>"><?php echo $row['phone']; ?></a><br>
                                                        <?php echo $row['cnic']; ?>
                                                    </td>

                                                    <td class="text-center round-right">
                                                        <a href='edit.php?id=<?php echo $row['id']; ?>'><i
                                                                class="fas fa-edit text-primary"></i></a><br>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input placeholder="Department" type="text" name="department"
                                                        id="department" class="form-control session" required />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input placeholder="Email" type="email" name="email"
                                                        id="email-input" class="form-control session" required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="file"
                                                        ...
                                                        class="form-control-file border" name="image" required />
                                                </div>
                                            </div>
                                        </div>
