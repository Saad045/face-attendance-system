                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <form action="updatedata.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <span>
                                                                <img src="../<?php echo $row['picture']; ?>"
                                                                    alt="profilePicture" name="picture" class="pb-3"
                                                                    style="width:100px;object-fit:cover;">
                                                                <input type="file"
                                                                    accept="image/png, image/jpg, image/jpeg, image/gif"
                                                                    class="form-control-file border" name="image" id="image" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="student_name" placeholder="Student Name"
                                                                class="form-control session" value="<?php echo $row['name']; ?>"
                                                                required />
                                                        </div>
                                                        <div class="form-group">
                                                            <input value="<?php echo $row['roll_no']; ?>" name="roll_no"
                                                                placeholder="Roll No" class="form-control session" required />
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input value="<?php echo $row['session']; ?>" type="text"
                                                                        name="session" id="myInput" placeholder="Session"
                                                                        class="form-control session" required />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input value="<?php echo $row['department']; ?>"
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input value="<?php echo $row['degree']; ?>" type="text"
                                                                name="degree" placeholder="Degree" class="form-control session"
                                                                required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <select name="shift" class="form-control session" required>
                                                                ...
                                                                <option value="morning" <?php if ($row['shift'] == 'morning') {
                                                                    echo "selected";
                                                                } ?>>Morning</option>
                                                                <option value="afternoon" <?php if ($row['shift'] == 'afternoon') {
                                                                    echo "selected";
                                                                } ?>>Afternoon</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input value="<?php echo $row['email']; ?>" type="email"
                                                                name="email" placeholder="Email" class="form-control session"
                                                                required />
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="form-group">
                            <input value="<?php echo $row['password']; ?>" type="password" name="password" placeholder="Password" class="form-control session" required />
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input value="<?php echo $row['cnic']; ?>" type="text" name="cnic"
                                                                id="cnic" placeholder="CNIC" class="form-control session"
                                                                required />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input value="<?php echo $row['phone']; ?>" type="text" name="phone"
                                                                id="phone" placeholder="Phone" class="form-control session"
                                                                required />
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" value="<?php echo $row['address']; ?>"
                                                                id="address" name="address" class="form-control session"
