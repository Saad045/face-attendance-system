                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="student_name"
                                                                    placeholder="Student Name" class="form-control session"
                                                                    value="<?php echo $row['name']; ?>" required />
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <input value="<?php echo $row['roll_no']; ?>" name="roll_no"
                                                                        placeholder="Roll No" class="form-control session"
                                                                        required />
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                            ...
                                                            <div class="form-row ">
                                                                <div class="form-group col-md-6">
                                                                    <input value="<?php echo $row['cnic']; ?>" type="text"
                                                                        name="cnic" id="cnic" placeholder="CNIC"
                                                                        class="form-control session" required />
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input value="<?php echo $row['shift']; ?>" type="text"
                                                                    name="shift" placeholder="Shift"
                                                                    class="form-control session" required />
                                                            </div>
                                                        </div>
                                                    </div>
