...
<div class="course_wrapper">
    ...
    <div class="col-md-10">
        <div class="row">
            <div class="col-md-6">
                <h3 class="font-weight-bold my-4 px-4 pb-2"><a href="../student/student.php" class=" text-decoration-none"><i class="fas fa-arrow-circle-left   mr-1"></i></a>Student Promotion</h3>
            </div>
        </div>
