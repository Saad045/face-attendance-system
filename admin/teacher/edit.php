...
<body>
    ...
    ?>
                                        <form action="updatedata.php" method="post" enctype="multipart/form-data">
                                            <div class="row pb-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <label for=""></label>
                                                        ...
                                                        <span>
                                                            <img src="./<?php echo $row['image']; ?>" alt="profilePicture" name="picture" style="height: 100px;width:100px;object-fit: cover;">
                                                        </span>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?php echo $row['qualification']; ?>" type="text" name="qualification" placeholder="Qualification"
                                                    ...
                                                    <div class="form-row ">
                                                        <div class="form-group col-md-6">
                                                            <input value="<?php echo $row['cnic']; ?>" type="text" id="cnic" name="cnic" placeholder="CNIC"
                                                                class="form-control session" required/>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <input value="<?php echo $row['mobile_no']; ?>" type="text" id="phone" name="phone" placeholder="Phone"
                                                                class="form-control session" required/>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <input value="<?php echo $row['email']; ?>" type="email" id="email-input" name="email" placeholder="Email"
                                                        class="form-control session" required/>
                                                </div>
                                                <script>
                                            ...
                                            <div class="form-group">
                                                        ...
                                                        <input value="<?php echo $row['address']; ?>" type="text" name="address" placeholder="Address"
                                                            class="form-control session" required/>
                                                    </div>
