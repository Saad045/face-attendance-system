...
<div class="course_wrapper">
    ...
    <div class="col-md-10">
        <div class="row">
            <div class="col-md-6">
                <h3 class="font-weight-bold my-4 px-4 pb-2"><i class="fas fa-book  mr-1"></i>Managing Courses</h3>
            </div>
        </div>
                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr class="row-color">
                            ...
                            <td class="text-center round-left"><?php echo $row['id']; ?></td>

                            <td class="text-center"><?php echo $row['name']; ?></td>
                            <td class="text-center "><?php echo $row['course_code']; ?></td>
                            <td class="text-center "><?php echo $row['credit_hour']; ?></td>
        ...
        <div class="col-md-5 pb-4 ">
            ...
            <div class="department p-2">
                <h5 class="font-weight-bold dept-heading mb-3">ADD COURSE</h5>
                <form action="savedata.php" method="post">
                    <div class="form-row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input placeholder="Course Name" type="text" name="course_name" class="form-control session" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input placeholder="Course Code" type="text" name="course_code" class="form-control session" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input placeholder="Credit Hours" type="number" name="credit_hour" class="form-control session" required />
                            </div>
                        </div>
                            
                        <div class="col-md-6">
                            <div class="form-group">
                                <input placeholder="Lecture Hours" type="text" name="hours" class="form-control session" required />
                            </div>
                        </div>
                    </div>
