                                    ...
                                    <div class="department p-2">
                                        ...
                                        <form action="updatedata.php" method="post" enctype="multipart/form-data">
                                            <div class="row pb-2">
                                                ...
                                                <div class="form-group">
                                                  <label>Date</label>
                                                  <input type="date" name="date" class="form-group session"value="<?php echo $row['date']; ?>" readonly/>
                                                </div>

                                                <div class="form-group">
                                                  <label>Lecture_number</label>
                                                  <input type="text" name="lec_num" class="form-group session"value="<?php echo $row['lec_num']; ?>" readonly/>
                                                </div>
                                                <div class="form-group">
