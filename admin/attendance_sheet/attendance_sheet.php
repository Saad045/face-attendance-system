                    ...
                    <div class="row px-4">
                        ...
                        <div class="col-md-4 pb-2 ">
                            ...
                            <?php if (!empty($alertMessage)): ?>
                                <?php if ($alertMessage === 'Data saved successfully.'): ?>
                                                ...
                                                <form class="post-form" action="savedata.php" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="student" id="student"
                                                            value="<?php echo $row1['student_id']; ?>" />
                                                        <!-- <label>TimeTableID</label> -->
                                                        <input type="hidden" name="time_table"
                                                            value="<?php echo $row1['timetable_id']; ?>" />
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control session" id="teacher" name="teacher"
                                                            required></select>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control ">
                                                            ...
                                                            <label class="mr-5 font-weight-bold"><input type="radio"
                                                                    name="attendance_status" value="P" required> Present</label>

                                                            <label class="font-weight-bold"><input type="radio"
                                                                    name="attendance_status" value="A" required> Absent</label>
                                                        </div>
                                                    </div><br>
