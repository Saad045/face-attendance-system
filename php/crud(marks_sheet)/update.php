...
<div id="main-content">
  ...
  <?php
    if(isset($_POST['showbtn'])){
      ...
      $sql = "SELECT mark_sheet.id, mark_sheet.mid, mark_sheet.final, mark_sheet.sessional, mark_sheet.student_id, student.name, student.roll_no, mark_sheet.course_id, course.name, mark_sheet.teacher_id, teacher.name FROM mark_sheet INNER JOIN student ON mark_sheet.student_id = student.id INNER JOIN course ON mark_sheet.course_id = course.id INNER JOIN teacher ON mark_sheet.teacher_id = teacher.id WHERE mark_sheet.id=$ms_id ORDER BY mark_sheet.id ASC";
