      ...
      <div class="row">
        <div class="col-md-2 container bg-dark text-white text-center sticky-top sidebar">
          <div>
            ...
            <div class="tab my-3"><a href="#">BSCS 7<sup>th</sup></a></div>
          </div>
        </div>
        ...
        <div class="col-md-5 container">
          <div class="px-4">
            <div class="d-flex justify-content-between align-items-center">
              <h5 class="font-weight-bold my-4">BSCS 7<sup>th</sup></h5>
              <div class="my-4">
        ...
        <div class="col-md-5">
          <div class="px-4">
            ...
            <div class="py-4">
              ...
              <div class="d-flex justify-content-between bg-color rounded px-3 py-1 mb-3">
