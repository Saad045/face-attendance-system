        ...
        <div class="col-md-10">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="d-flex justify-content-between align-items-center px-4">
                <h4 class="font-weight-bold text-uppercase my-4 py-1">
          ...
          <div class="row align-items-center justify-content-between px-5 pt-4">
            ...
            <div>
              ...
              <button type="submit" form="attendanceForm" class="btn btn-dark btn-sm" name="submit"><i class="fa fa-floppy-disk pr-2"></i>Save Attendance</button>
            </div>
          </div>

          <div class="row my-2 px-4">
            <div class="col-md-12">
              <div class="course p-2 mt-3" >
