<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      $output.='<p>-------------------------------------------------------------</p>';
      $output.='<p><a href="http://localhost/face-attendance-system/teacher/changepassword.php?token='.$token.'&email='.$email.'">
      http://localhost/face-attendance-system/teacher/changepassword.php?token='.$token.'&email='.$email.'</a></p>';
      $output.='<p>-------------------------------------------------------------</p>';
