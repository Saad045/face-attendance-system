...
$sqlformarks = "SELECT mark_sheet.id, student.roll_no, student.name AS student_name, mark_sheet.mid, mark_sheet.final, mark_sheet.sessional FROM mark_sheet INNER JOIN student ON mark_sheet.student_id = student.id WHERE mark_sheet.student_id=$student_id && mark_sheet.course_id=$course_id && mark_sheet.teacher_id=$teacher_id";
...
if (mysqli_num_rows($resultformarks) > 0) {
    ...
    if (isset($_POST['update_marks'])) {
		...
		header("Location: class.php?student_id=$student_id&course_id=$course_id&teacher_id=$teacher_id&timetable_id=$timetable_id");
	}
}
?>
	    ...
	    <div class="row justify-content-center">
      	<div class="col-md-10">
      		<div class="row align-items-center justify-content-between mb-3">
      			...
      			<button type="submit" class="btn btn-primary" name="update_marks">Update</button>
      		</div>
